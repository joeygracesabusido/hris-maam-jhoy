...
cusa: {
    all: ['cusa'] as const,
    units: {
      all: ['cusa', 'units'] as const,
      lists: () => [...queryKeys.cusa.units.all, 'list'] as const,
      list: (filters?: Record<string, string>) => [...queryKeys.cusa.units.lists(), filters] as const,
      details: () => [...queryKeys.cusa.units.all, 'detail'] as const,
      detail: (id: string) => [...queryKeys.cusa.units.details(), id] as const,
    },
    rates: {
      all: ['cusa', 'rates'] as const,
      lists: () => [...queryKeys.cusa.rates.all, 'list'] as const,
      list: (filters?: Record<string, string>) => [...queryKeys.cusa.rates.lists(), filters] as const,
      details: () => [...queryKeys.cusa.rates.all, 'detail'] as const,
      detail: (id: string) => [...queryKeys.cusa.rates.details(), id] as const,
    },
    bills: {
      all: ['cusa', 'bills'] as const,
      lists: () => [...queryKeys.cusa.bills.all, 'list'] as const,
      list: (filters?: Record<string, string>) => [...queryKeys.cusa.bills.lists(), filters] as const,
      details: () => [...queryKeys.cusa.bills.all, 'detail'] as const,
      detail: (id: string) => [...queryKeys.cusa.bills.details(), id] as const,
    },
    payments: {
      all: ['cusa', 'payments'] as const,
      lists: () => [...queryKeys.cusa.payments.all, 'list'] as const,
      list: (filters?: Record<string, string>) => [...queryKeys.cusa.payments.lists(), filters] as const,
    },
